...
actor = ActorNetwork(state_shapes[0], action_size, hiddens=[[256, 256]],
                     activations=['relu'], output_activation='tanh',
                     layer_norm=False, noisy_layer=False, scope='actor')

critic1 = CriticNetwork(state_shapes[0], action_size, hiddens=[[256], [256]],
                        activations=['relu', 'relu'],
                        layer_norm=False, noisy_layer=False,
                        action_insert_block=1, scope='critic1')

critic2 = CriticNetwork(state_shapes[0], action_size, hiddens=[[256], [256]],
                        activations=['relu', 'relu'],
                        layer_norm=False, noisy_layer=False,
...
agent_algorithm = TD3(state_shapes=state_shapes,
                      ...
                      target_actor_update_rate=2.5e-3,
