...
class DQN(BaseAlgoDiscrete):
    ...
    def build_graph(self):
        ...
        with tf.name_scope("critic_update"):
            q_values = self._critic(self.states_ph)
            ...
            # print('actions', self.actions_ph)
            # print('r', self.rewards_ph, self.rewards_ph[:, None])
            ...
            # print('q val', q_values_selected)
            # print('diff', q_values_selected - tf.stop_gradient(td_targets))
